...
contract ClinicalTrialRegistry {
    ...
    function submitTrial(
        ...
        require(msg.sender == owner || nodes[msg.sender].active, "Node not active");
    ...
    function appendBlock(
        ...
        require(msg.sender == owner || (
            (nodes[msg.sender].role == NodeRole.PROTOCOL_VALIDATOR || nodes[msg.sender].role == NodeRole.CONSENT_VERIFIER) &&
            nodes[msg.sender].active &&
            nodes[msg.sender].reputationScore >= MIN_REPUTATION
        ), "Validators only");
    ...
    ) external trialMustExist(trialId) {
        require(msg.sender == owner || (
            nodes[msg.sender].role == NodeRole.COMPLIANCE_AUDITOR &&
            nodes[msg.sender].active
        ), "Insufficient role");
